...
contract LimitOrderHook is BaseHook {
    ...
    event OrderCreated(
        uint256 indexed orderId, address indexed creator, uint96 amount0, uint96 amount1, uint128 triggerPrice
    );
    ...
    function createLimitOrder(PoolKey calldata poolKey, uint96 amount0, uint96 amount1, uint128 triggerPrice)
        external
